...
/* Verein_v3.tpl – seitenspezifisch (C1). Gliederung/Reihenfolge seit W8 an
   ...
   neun Zeilen). Die Abteilungskacheln Fußball/Karneval bleiben nur in der
   App (kein Website-Äquivalent). .visually-hidden und .zeile__untertitel
...
/* W8, Befund 6: "5 Gruppen"/"11 Mannschaften" nie mitten in der Zahl-Wort-
   Gruppe umbrechen. */
#anzahl-fussball,
#anzahl-karneval {
  white-space: nowrap;
...
<div class="abteilungen-raster">
  <a class="karte abteilung-karte" href="nav://sportfreunde04_TextImage_1783343147611">
    <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" fill="none" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
      <circle cx="12" cy="12" r="8.5"/>
      <path d="M12 8.8l3.04 2.21-1.16 3.58h-3.76l-1.16-3.58z"/>
      <path d="M12 8.8V4.8M15.04 11.01l3.6-1.3M13.88 14.59l2.2 3.4M10.12 14.59l-2.2 3.4M8.96 11.01l-3.6-1.3"/>
    </svg>
  ...
  <a class="karte abteilung-karte" href="nav://sportfreunde04_TextImage_1780401660343">
    <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" fill="none" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
      <path d="M4 10c0-4 3.6-6.5 8-6.5s8 2.5 8 6.5c0 3-3.2 5-8 5s-8-2-8-5z"/>
      <path d="M8.3 9.2c.6-.5 1.6-.5 2.2 0M13.5 9.2c.6-.5 1.6-.5 2.2 0"/>
      <path d="M4 9.5L1.8 8M20 9.5l2.2-1.5"/>
    </svg>
    <p class="abteilung-karte__titel">Karneval</p>
    <!-- W10, Auftrag D (app Nr. 10/quervergleich Nr. 15): "Die Schnauzer"
         steht schon auf der Karnevalseite selbst – der Zusatz hier brach nur
         mit einsamem Trennpunkt am Zeilenende um; die Fußball-Karte daneben
         zeigt ebenfalls nur die reine Zählung ("11 Mannschaften"). -->
    <p class="abteilung-karte__untertitel"><span id="anzahl-karneval">Gruppen</span></p>
  </a>
</div>
